<h2 class="pl-3">Tambah Matakuliah</h2>
<hr>
<div class="col-sm-8">
	<form class="form-horizontal" method="post">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" name="kode" id="inputEmail3" value="<?php echo set_value('kode'); ?>">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" name="makul" id="inputPassword3" value="<?php echo set_value('makul'); ?>">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" name="prodi" id="inputPassword3" value="<?php echo set_value('prodi'); ?>">
